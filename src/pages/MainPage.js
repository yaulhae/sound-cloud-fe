                    ...
                    <div className="layout_left">
                        ...
                        <div className="flex_box">
                            <Text size="2rem" margin="0 0 1em 0">
                                ...
                                <p className="font">
                                    {' '}
                                    Popular playlists from the SoundCloud
                                    community
                                </p>
                            </Text>
                        </div>
                        ...
                        <div className="flex_box">
                            <Text size="2rem" margin="0 0 1em 0">
                                ...
                                <p className="font">
                                    {' '}
                                    The most played tracks on SoundCloud this
                                    week
                                </p>
                            </Text>
                        </div>
                                ...
                                <div>
                                    <p>
                                        <Grid>
                                            <div>
                                                <div className="flex-container">
                                                    {Charts?.hiphopCategoryMusic?.map(
                                                        (stream, idx) => {
                                                            return (
                                                                <div
                                                                    className="flex_box"
                            ...
                            <div className="right_container">
                                ...
                                <Grid>
                                    ...
                                    <Text>
                                        ...
                                        Manager ⁃ Imprint ⁃ Creator Resources ⁃
                                        Blog ⁃ Charts ⁃
                                        <span className="font-color">
                                            Language:
                                        </span>
                                        <span className="font-color2">
                                            English (US)
                                        </span>
                                    </Text>
                                </Grid>
